...
<template>
  <div
    class="p-input"
    :class="{
      [`p-input--${type}`]: props.type,
      [`p-input--${size}`]: props.size,
    ...
    <template v-if="type !== 'textarea'">
      ...
      <div v-if="$slots.prepend" class="p-input__prepend">
        <slot name="prepend"></slot>
      </div>
      <!-- 输入框 -->
      <div class="p-input__wrapper">
        <!-- 输入框头部内容，只对非 type="textarea" 有效 -->
        <span v-if="$slots.prefix" class="p-input__prefix">
        ...
        <span v-if="$slots.suffix || showClear || showPasswordArea" class="p-input__suffix" @click="keepFocus">
          ...
          <PIcon
            ...
            icon="eye"
            @click="togglePasswordVislble"
            class="p-input__password" />
      ...
      <div v-if="$slots.append" class="p-input__append">
